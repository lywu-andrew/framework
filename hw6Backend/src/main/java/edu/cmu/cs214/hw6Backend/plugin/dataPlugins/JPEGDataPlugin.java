...
public class JPEGDataPlugin implements DataPlugin {
    private static final String SUPPORTED_FILE_TYPE = ".jpg";
    private static final String PLUGIN_NAME = "JPEG Data Plugin";
